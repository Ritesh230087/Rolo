// // test/features/auth/presentation/view/login_screen_test.dart
...
// // Other necessary imports for the screen's dependencies (themes etc)
...
//   setUpAll(() {
//     registerFallbackValue(LoginResetEvent());
//   });
...
//   group('LoginScreen', () {
//     testWidgets('tapping login button dispatches LoginWithEmailAndPasswordEvent', (tester) async {
//       // Arrange
...
//       expect(captured.whereType<LoginWithEmailAndPasswordEvent>().length, 1);
//     });
...
//       when(() => mockLoginViewModel.stream).thenAnswer((_) => Stream.value(const LoginState(isLoading: true, isSuccess: false, canUseBiometrics: false)));
